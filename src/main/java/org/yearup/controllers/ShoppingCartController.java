...
public class ShoppingCartController {
    ...
    public ShoppingCart updateCart(Principal principal, @PathVariable ShoppingCartItem shoppingCartItem) {
        shoppingCartDao.updateItem(shoppingCartItem);
    ...
    public ShoppingCart delete (Principal principal, @PathVariable ShoppingCartItem shoppingCartItem){
        shoppingCartDao.deleteAllItems(shoppingCartItem);
        return null;
    }
