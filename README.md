# EcommerceAPI 
## Project summary: This capstone is an e-commerce application, or an online store. The website uses a Spring Boot API project for the backend server, with a 
